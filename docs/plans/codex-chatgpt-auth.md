...
- **Remaining:** the container app-server blocker (above); open questions 2–4 (container concurrency policy, k8s, Enterprise token path); the SSE-MCP parity gap (dapr/obs/workflows tools for codex) if codex work ever needs them.
