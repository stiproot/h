...
The local substrate also has an **event fabric** (`h events`, POC —
docs/plans/nats-event-substrate.md): one `nats-server -js` child (operator-provisioned binary,
