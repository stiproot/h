...
#               against cli/scripts/payloads/domain/feature-requests/ (the gitignored home for these
...
# (cli/scripts/clone.sh); the task template at payloads/domain/feature-request-task.template.json
