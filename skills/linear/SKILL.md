...
```bash
~/.claude/skills/linear/cli/scripts/get-issue.sh <ISSUE_ID>     # e.g. ABC-123
```
...
```bash
~/.claude/skills/linear/cli/scripts/add-comment.sh <ISSUE_ID> <BODY_FILE>   # e.g. add-comment.sh ABC-123 findings.md
cat findings.md | ~/.claude/skills/linear/cli/scripts/add-comment.sh <ISSUE_ID> -   # or from stdin
```
